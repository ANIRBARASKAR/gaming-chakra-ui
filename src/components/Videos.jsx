import { Heading,Button, Stack, VStack , Text } from '@chakra-ui/react'
...
<VStack w={'full'}>
    ...
    <VStack alignItems={"flex-start"} p={'8'} w={'full'} overflowY={'auto'}>
        ...
        <Text> This is a sample Videos for testing</Text>
    </VStack>
</VStack>
...
{
    videoarr.map((item, index) => <Button variant={'ghost'} colorScheme={'purple'} onClick={ ()=> setvideosrc(item)}> Leacture {index + 1 }</Button>
